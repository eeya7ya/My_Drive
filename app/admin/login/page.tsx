 ...
 */
/**
 * Where the form is allowed to send the browser afterwards: somewhere on this
 * site, and nowhere else.
 *
 * Checking only for a leading "/" is not enough. A second slash makes it a
 * protocol-relative URL, and a backslash is folded to a slash by the URL
 * parser browsers use — so a next of /\evil.example reads as this site here
 * and as another origin in the browser, which would hand the admin over the
 * instant the password was accepted.
 */
